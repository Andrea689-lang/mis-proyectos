...
SELECT 
	...
	COUNT(*) AS "Number of Hires"
FROM employees
WHERE
	MONTHS_BETWEEN(SYSDATE,hire_date)/12 >= 15
...
**********************************************************************************/
SELECT 
	'Drinkers: ' || COUNT(*) AS "Party goers"
FROM 
	ICS120.PEOPLE
WHERE
	MONTHS_BETWEEN('03-DEC-2018',birth_date)/12 >= 35;
...
(customer_id, first_name, last_name, dob, phone)
VALUES
(200,'Natalia', 'Ariza', TO_DATE('March 15, 2004', 'MONTH DD YYYY'),'250-986-4177');
/*********************************************************************************
 Question 12
 Confirm your changes to the table. Order by customer_id. 
**********************************************************************************/
...
Insert into customers 
 (customer_id, first_name, last_name, dob, phone)
Values 
(400, 'Natalia', 'Ariza',To_Date('March 15, 2004', 'MONTH DD, YYYY'), '250-986-4177'); 
...
Reason #1: the savepoint was invalid since we did a full commit 
...
Select customer_id,
       first_name,
	   last_name,
	   To_Char(dob,'Month DD, YYYY') as "Date",
	   phone
From customers 
Order By customer_id ASC;	   
